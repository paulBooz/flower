...
```
Disclamier: Please note that since the experiments were conducted for the paper, the dataset authors have slightly modified the dataset. While this modification may lead to minor differences in accuracy, `StatAvg` should still consistently outperform `FedAvg` as demonstrated in the paper.
